async function getCoordinates(cityName, apiKey = '9d8e8a4aefa14bf18523a9d8d92f13ed') {
...
document.addEventListener("DOMContentLoaded", () => {
 ...
 async function checkWeather(city) {
        try {
            ...
            document.querySelector(".temp").innerHTML = Math.round(data.hourly.temperature_2m[0]) + "°F";
            document.querySelector(".humidity").innerHTML = "Humidity: " + data.hourly.relative_humidity_2m[0] + "%";
            document.querySelector(".wind").innerHTML = "Wind: " + data.hourly.wind_speed_10m[0] + " m/s";
